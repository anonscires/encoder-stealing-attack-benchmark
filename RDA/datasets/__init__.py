...
from .query_dataset import get_query_cifar10, get_protos_cifar10, get_query_pair_conventional_cifar10, get_query_pair_stolenencoder_cifar10, get_query_pair_consteal_cifar10,\
    ...
    get_query_svhn, get_query_cifar10stl10svhn, get_protos_svhn, get_protos_cifar10stl10svhn, get_query_pair_conventional_svhn, get_query_pair_stolenencoder_svhn, get_query_pair_consteal_svhn,\
    ...
    get_query_imagenet_224, get_protos_imagenet_224, get_downstream_test_data, get_protos_stl10_224, get_query_stl10_224, get_query_cifar10_224, \
    get_protos_cifar10_224, get_query_svhn_224, get_query_cifar10stl10svhn_224, get_protos_svhn_224, get_query_gtsrb_224, get_protos_gtsrb_224, get_protos_cifar10stl10svhn_224
...
def get_query_dataset(args):
    if ('resnet' in args.architecture) or (args.pretraining_dataset not in ['imagenet', 'clip']):
        # resnet needs 32x32 images
        ...
        elif args.query_dataset in ['cifar10stl10svhn', 'cifar10stl10', 'cifar10svhn', 'stl10svhn']:
            return get_query_cifar10stl10svhn(args)
    else:
        if args.query_dataset == 'imagenet':
            return get_query_imagenet_224(args)
        elif args.query_dataset == 'stl10':
            return get_query_stl10_224(args)
        elif args.query_dataset == 'cifar10':
            return get_query_cifar10_224(args)
        elif args.query_dataset == 'svhn':
            return get_query_svhn_224(args)
        elif args.query_dataset == 'gtsrb':
            return get_query_gtsrb_224(args)
        elif args.query_dataset in ['cifar10stl10svhn', 'cifar10stl10', 'cifar10svhn', 'stl10svhn']:
            return get_query_cifar10stl10svhn_224(args)

    # If we reach here, it means no matching case was found
    raise ValueError(f"Unsupported combination: pretraining_dataset='{args.pretraining_dataset}', query_dataset='{args.query_dataset}'")
...
def get_proto_dataset(args, query_data_sampling_indices):
    if args.pretraining_dataset not in ['imagenet', 'clip']:
        if args.query_dataset == 'cifar10':
            ...
            return get_protos_cifar10stl10svhn(args, query_data_sampling_indices)
    else:
        if args.query_dataset == 'imagenet':
            ...
            return get_protos_cifar10_224(args, query_data_sampling_indices)
        elif args.query_dataset == 'svhn':
            return get_protos_svhn_224(args, query_data_sampling_indices)
        elif args.query_dataset == 'gtsrb':
            return get_protos_gtsrb_224(args, query_data_sampling_indices)
        elif args.query_dataset in ['cifar10stl10svhn', 'cifar10stl10', 'cifar10svhn', 'stl10svhn']:
            return get_protos_cifar10stl10svhn_224(args, query_data_sampling_indices)
