...
if __name__ == '__main__':
    ...
    if args.pretraining_dataset in ['cifar10', 'stl10']:
        ...
        target_model = target_model.f         # if target encoder != densenet or mobilenet, then we need this
    elif args.pretraining_dataset in ['clip']:
        target_model = DinoEncoder(base_model='dino-vitb16', out_dim=768, include_mlp=False, pretrained=True).cuda()
    ...
    surrogate_model = ResNetEncoder(base_model=args.architecture, out_dim=768, include_mlp=True).cuda()
