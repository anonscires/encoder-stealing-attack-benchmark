...
run_train(0, 'cifar10', 'cifar10', 9000, 100, 0, 0, epochs=100, batch_size=128)
run_train(1, 'stl10', 'stl10', 9000, 100, 0, 0, epochs=100, batch_size=128)
run_train(2, 'svhn', 'svhn', 9000, 100, 0, 0, epochs=100, batch_size=128)